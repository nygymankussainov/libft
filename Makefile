...
#    Updated: 2019/07/12 12:56:16 by vhazelnu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memmove.c ft_strcmp.c ft_strncpy.c ft_itoa.c ft_memset.c ft_strcpy.c ft_strndup.c \
	  ...
	  ft_isalpha.c ft_lstnew.c ft_putnbr_fd.c ft_strjoin.c ft_strsplit.c ft_isascii.c ft_memalloc.c \
	  ...
	  ft_revstr.c ft_swap_str.c ft_power_db.c ft_putstr.c ft_realloc.c ft_bzero_null.c
